...
export default function PersonTable({ persons }: PersonTableProps) {
  ...
  const sortedPersons = [...persons].sort((a, b) => {
    ...
    switch (sortConfig.key) {
      ...
      case "local":
        aValue =
          a.ultimaOcorrencia?.localDesaparecimentoConcat?.toLowerCase() || "";
        bValue =
          b.ultimaOcorrencia?.localDesaparecimentoConcat?.toLowerCase() || "";
        break;
      default:
        return 0;
    }
          ...
          <TableRow>
            ...
            <TableHead>
              <Button
                ...
                aria-label={`Ordenar por nome, atualmente ${
                  getSortDirection("nome") || "não ordenado"
                }`}
              >
            ...
            <TableHead>
              <Button
                ...
                aria-label={`Ordenar por idade, atualmente ${
                  getSortDirection("idade") || "não ordenado"
                }`}
              >
            ...
            <TableHead>
              <Button
                ...
                aria-label={`Ordenar por sexo, atualmente ${
                  getSortDirection("sexo") || "não ordenado"
                }`}
              >
            ...
            <TableHead>
              <Button
                ...
                aria-label={`Ordenar por data, atualmente ${
                  getSortDirection("data") || "não ordenado"
                }`}
              >
            ...
            <TableHead className="hidden md:table-cell">
              <Button
                ...
                aria-label={`Ordenar por local, atualmente ${
                  getSortDirection("local") || "não ordenado"
                }`}
              >
