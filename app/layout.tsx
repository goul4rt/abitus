...
export const metadata = {
  title: "Sistema de Pessoas Desaparecidas - Polícia Judiciária Civil de Mato Grosso",
  description:
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      <head>
        <link rel="icon" href="https://www.sesp.mt.gov.br/o/mt-portal-theme/images/favicon.ico" />
        <link rel="canonical" href="https://abitus.pjc.mt.gov.br" />
              ...
              <div className="min-h-screen flex flex-col">
                  ...
                  <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                    <Link href="/" className="flex items-center gap-2" aria-label="Ir para página inicial">
                      <div className="rounded-full bg-white p-2">
                        <img
                          src="https://www.sesp.mt.gov.br/o/mt-portal-theme/images/favicon.ico"
                          alt="Logo Governo MT"
                          className="h-8 w-8"
                        />
                      </div>
                      <div>
                        ...
                        <p className="text-xs text-white/80">Polícia Judiciária Civil de Mato Grosso</p>
                      </div>
                    </Link>

                    <div className="flex items-center gap-2">
                      <nav className="hidden md:flex items-center space-x-4 mr-4" aria-label="Navegação principal">
                        <Link
                          href="/"
                ...
                <footer className="py-6 gov-footer">
                  <div className="container mx-auto px-4 text-center text-sm text-white/80">
                    <p>
                      © {new Date().getFullYear()} Polícia Judiciária Civil de Mato Grosso - Todos os direitos
                      reservados
                    </p>
                    <p className="mt-1">Sistema ABITUS - Pessoas Desaparecidas</p>
                    <div className="mt-4 flex justify-center space-x-4">
                      ...
                      <a href="#" className="text-white hover:text-mt-yellow" aria-label="Política de Privacidade">
